            ...
            getDummyCategories() {
                return [
                    ...
                    },
                    {
                        ...
                        subcategories: ["Obat", "Vitamin", "Alat Kesehatan", "Perawatan"]
                    },
                    {
                        name: "Olahraga",
  ...
  this.shadowRoot.appendChild(faLink);
                ...
                template.innerHTML = `
                    <nav>
                        ...
                        <div class="nav-icons">
                            <a href="#" class="nav-icon" id="transaksiBtn">
                                <i class="fas fa-file-invoice"></i>
                                <span>Transaksi</span>
                            </a>
                            
                            <a href="#" class="nav-icon" id="keranjangBtn">
                            ...
                            <div class="profile-container">
                                ...
                                <div class="profile-dropdown">
                                    <a href="#" id="settingsBtn"><i class="fas fa-user-cog"></i> Setting Profile</a>
            ...
            initEventListeners() {
                ...
                const kategoriDropdown = this.shadowRoot.getElementById('kategoriDropdown');
                ...
                // Navigation buttons
                ['transaksiBtn', 'keranjangBtn', 'settingsBtn', 'logoutBtn'].forEach(id => {
